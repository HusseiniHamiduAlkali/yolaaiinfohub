        ...
        <div class="navbar-links-container">
          <ul class="navbar-links">
            ...
            <li><button onclick="window.loadSection('communityinfo')">
              ...
              <span data-i18n="communityinfo">CommunityInfo</span></button>
            </li>

            <li>
              <button onclick="window.loadSection('ecoinfo')">                
                <i class="fas fa-recycle"></i>
              <span data-i18n="ecoinfo">EcoInfo</span></button>
            </li>
            
            <li><button onclick="window.loadSection('agroinfo')">
                <svg viewBox="0 0 24 24" width="24" height="22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M12 18V7"/>
                ...
                <span data-i18n="agroinfo">AgroInfo</span>
              </button>
            </li>
            ...
            <li><button onclick="window.loadSection('serviinfo')">
                ...
                <span data-i18n="serviinfo">ServiInfo</span>
              </button>
            </li>
