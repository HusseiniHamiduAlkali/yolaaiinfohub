...
// Function to populate LGA dropdown based on selected state
function updateLGAOptions(stateSelect, lgaSelect) {
  const state = stateSelect.value;
  const lgas = window.STATES_LGAS[state] || [];
  ...
  lgas.forEach(lga => {
    ...
    option.value = lga.toLowerCase().replace(/ /g, '-');
